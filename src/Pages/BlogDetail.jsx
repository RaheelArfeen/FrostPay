...
const blogPostsData = [
  {
    ...
    excerpt:
      "Discover practical tips to reduce your utility expenses during the cold winter months without sacrificing comfort.",
    content: `
  ...
  },
  {
    ...
    excerpt:
      "Learn to decode the various charges on your electricity bill and understand what you're really paying for each month.",
    content: `
  ...
  },
  {
    ...
    excerpt:
      "How blockchain and AI technologies are revolutionizing the way we pay bills and manage financial transactions.",
    content: `
...
const BlogDetails = () => {
  ...
  if (loading) {
    return (
      <div className="max-w-[1400px] w-full mx-auto px-4 py-16 flex justify-center">
  ...
  if (!post) {
    return (
      <div className="max-w-[1400px] w-full mx-auto px-4 py-16 flex flex-col items-center">
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="relative h-[400px] w-full overflow-hidden">
        ...
        />
        <div className="absolute bottom-0 md:max-w-[1400px] w-full left-1/2 -translate-x-1/2 w-full py-6 md:py-12 px-4 z-20">
          <button
            onClick={goBack}
      ...
      <div className="max-w-[1400px] w-full mx-auto px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          <div className="lg:col-span-8">
            <div className="bg-white rounded-lg overflow-hidden">
              ...
              <div
                className="prose prose-frost max-w-none"
          ...
          <div className="lg:col-span-4">
            ...
            <div className="py-6">
              ...
              <div className="flex gap-2">
                <button className="px-4 py-2 border border-gray-300 w-full rounded-mdflex justify-center items-center gap-2">
                  <Save size={18} /> Save
                </button>
                <button className="px-4 py-2 border border-gray-300 w-full rounded-md flex justify-center items-center gap-2">
